...
List<GalleryItem> galleryData = [
  GalleryItem(
    imageTitle: 'Reichstag \nBuilding',
    imageDate: '2023-07-01',
    imageDescription: 'Reichstag Building in Berlin',
    imagePath: 'assets/images/hoch3media-tccpANvOY_4-unsplash.jpg',
  ),
  GalleryItem(
    imageTitle: 'Brandenburg \nGate',
    imageDate: '2023-07-02',
    imageDescription: 'Brandenburg Gate in Berlin',
  ...
  GalleryItem(
    imageTitle: 'Museum \nIsland',
    imageDate: '2023-07-04',
    imageDescription: 'Museum Island in Berlin',
    imagePath: 'assets/images/detait-Lrc7QxUWjq4-unsplash.jpg',
  ),
  GalleryItem(
    imageTitle: 'Berliner \nDom',
    imageDate: '2023-07-05',
    imageDescription: 'Berliner Dom in Berlin',
